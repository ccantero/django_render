...
TELEGRAM_DELIVERY_TIMEOUT_SECONDS = env.int('TELEGRAM_DELIVERY_TIMEOUT_SECONDS', default=10)
PORTFOLIO_STATUS_MAX_SNAPSHOTS = env.int('PORTFOLIO_STATUS_MAX_SNAPSHOTS', default=512)
...
if not DEBUG:
    ...
    print("Running with DEBUG FALSE")
